export default {
  'login:do': '/app/login/index.html',
  'login:out': '/app/login/out.html',
  'login:get-rsa-key': '/app/login/getRsaKey.html',
  'sms-code:login': '/app/login/sendSmsCode.html',
  'sms-code:update-phone': '/app/user/sendSmsCode.html',

  'user:info-get': '/app/user/getInfo.html',
  'user:access.get': '/app/user/getAccess.html',
  'user:info-update': '/app/user/updateInfo.html',
  ...
  'message:unread.clear': '/app/message/clearunread.html',
  ...
  'hot-text:ads.del': '/app/Hottext/delAd.html',
  'hot-text:content.publish': '/app/Hottext/publish.html',
  'hot-text:content.delete': '/app/Hottext/delete.html'
}
